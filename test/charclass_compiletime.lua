...
assert_equals({parse("aa[%a[c]]b", "[", 3, ctx)}, {
  {codes = {utf8.byte("c")}, ranges = nil, classes = {'alpha'}, not_classes = nil},
  utf8.raw.len("[%a[c]]")
})

assert_equals({parse("aa[[c]%a]b", "[", 3, ctx)}, {
  {codes = {utf8.byte("c")}, ranges = nil, classes = {'alpha'}, not_classes = nil},
  utf8.raw.len("[[c]%a]")
})
...
assert_equals({parse("aac-db", "c", 3, ctx)}, {
  {ranges = {{utf8.byte("c"),utf8.byte("d")}}},
  utf8.raw.len("c-d")
})
assert_equals(ctx.internal, true)
...
assert_equals({parse("aa[c-]]b", "[", 3, ctx)}, {
  {codes = nil, ranges = {{utf8.byte("c"),utf8.byte("]")}}, classes = nil, not_classes = nil},
  utf8.raw.len("[c-]]")
})
assert_equals(ctx.internal, true)
...
assert_equals({parse("бб[%a[ц]]ю", "[", #"бб" + 1, ctx)}, {
  {codes = {utf8.byte("ц")}, ranges = nil, classes = {'alpha'}, not_classes = nil},
  utf8.raw.len("[%a[ц]]")
})

assert_equals({parse("бб[[ц]%a]ю", "[", #"бб" + 1, ctx)}, {
  {codes = {utf8.byte("ц")}, ranges = nil, classes = {'alpha'}, not_classes = nil},
  utf8.raw.len("[[ц]%a]")
})
...
assert_equals({parse("бб[ц-]]ю", "[", #"бб" + 1, ctx)}, {
  {codes = nil, ranges = {{utf8.byte("ц"),utf8.byte("]")}}, classes = nil, not_classes = nil},
  utf8.raw.len("[ц-]]")
})
...
assert_equals({parse("бб[[ц]%a[ы]]ю", "[", #"бб" + 1, ctx)}, {
